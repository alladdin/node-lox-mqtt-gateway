...
var Gateway = function (structure, mqtt_prefix) {
...
Gateway.prototype.set_value_for_uuid = function(uuid, value) {
    this.structure.set_value_for_uuid(uuid, value);
};

Gateway.prototype.get_command_from_topic = function(topic, data) {
...
Gateway.prototype.get_topic_for_subscription = function() {
    return this.mqtt_prefix + '/+/+/+/cmd'
};

Gateway.prototype.abort = function() {
    this.structure.removeAllListeners();
    this.structure = undefined;
    this.removeAllListeners();
};

Gateway.prototype._build_rooms = function() {
...
Gateway.prototype._build_cats = function() {
...
Gateway.prototype._build_paths = function() {
...
Gateway.prototype._register_events = function() {
    var that = this;
...
Gateway.prototype._add_control = function(control, default_room, default_category){
...
Gateway.prototype._normalize_name = function(name){
